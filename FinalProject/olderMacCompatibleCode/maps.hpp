...
public:
    ...
    bool deleteEntry(const std::string& staff, const std::string& project) {
        ...
        if (database.find(key) == database.end()) {
            ...
            database.erase(key);
            ScreenMsg::print("[PROJECT-DB] Project deleted\n");
        }
        return true;
    }
    ...
    bool deleteMeasurementRange(const std::string& staff, const std::string& project, 
        ...
        if (dbProjectIterator != database.end()) {
            ...
            theProject->deleteMeasurementRange(startTime, endTime);
            ScreenMsg::print("[PROJECT-DB] Measurements deleted\n");
        } else {
            ErrorMsg::print("[PROJECT-DB] No project found");
            return false;
        } 
        return true;  
    }
    ...
    std::string show(const std::string& staffName, const std::string& projectName) {
        ...
        if (dbProjectIterator != database.end()) {
            ...
            ErrorMsg::print("[PROJECT-DB] Data does not exist!\n");
            return "";
        }
        return stringStream.str();
    }

...
/* ------------------------------------------------------------------------
* DEFINE A FRIEND OF HEADER LINE CLASS TO OVERLOAD ISTREAM OPERATOR>>
* -----------------------------------------------------------------------*/
...
std::ostream& operator<<(std::ostream& os, const HeaderLine& userHeaderLine) {
	os << userHeaderLine.name << std::endl;
	return os;
}